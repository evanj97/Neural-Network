...
# Intended to be used with the MNIST dataset.  However, adapting
# it to other classification problems should not be difficult.
# Most functions and the SLNN class have been written pseudo-generically
